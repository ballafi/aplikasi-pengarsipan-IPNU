                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-center gap-1">
                      ...
                      <?php if (isset($_SESSION['status_user']) && strtolower($_SESSION['status_user']) === 'admin'): ?>
                        <a href="surat_keluar/halaman_delete_surat_keluar.php?id_surat_keluar=<?= $row['id_surat_keluar']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i></a>
                      <?php endif; ?>
                    </td>
                  </tr>
                <?php endwhile; ?>
