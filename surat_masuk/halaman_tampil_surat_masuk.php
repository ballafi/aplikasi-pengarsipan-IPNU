...
<?php echo 'Status User: ' . ($_SESSION['status_user'] ?? 'Belum login'); ?>
                ...
                <?php while ($row = $result->fetch_assoc()) : ?>
                  <tr>
                    ...
                    <td class="d-flex justify-content-center gap-1">
                      ...
                      <?php if (isset($_SESSION['status_user']) && strtolower($_SESSION['status_user']) === 'admin'): ?>
                        <a href="index.php?page=surat_masuk&item=delete_surat_masuk&id_surat_masuk=<?= $row['id_surat_masuk']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')">
